...
{
    sealed class ActionProfileConveyorSorterIdle : ActionProfile<IMyConveyorSorter>
    {

        public override IEnumerable<string> ActionNames => new[] { "Idle" };
        ...
        public override Action<IMyConveyorSorter, IDictionary<string, string>> OnActionCallback =>
            (block, args) => block.DrainAll = false;
