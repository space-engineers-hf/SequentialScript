...
|                               | Toggle                 | Changes the door state between open and close                    | Door is open or closed (not moving)                                                              |                       |                                                                                           |
...
|                               |                        |                                                                  |                                                                                                  | /FULL                 | Waits until connector is out of the radius of the other connector (white color)           |
...
|                               | Detach                 | Detaches the head from the base                                  | There is no head attached on the base                                                            |                       |                                                                                           |
|                               | Set                    | Changes some property or properties in the block                 |                                                                                                  |                       |                                                                                           |
|                               |                        |                                                                  |                                                                                                  | /MAX:\<number>        | Sets the maximun displacement of the rotor                                                |
|                               |                        |                                                                  |                                                                                                  | /MIN:\<number>        | Sets the minimun displacement of the rotor                                                |
| Piston                        | Extend                 | Sets positive displacement                                       | Piston is fully extended                                                                         |                       |                                                                                           |
|                               | Retract                | Sets negative displacement                                       | Piston is fully retracted                                                                        |                       |                                                                                           |
|                               | Reverse                | Reservers piston displacement                                    | Piston is fully extended or retracted (not moving)                                               |                       |                                                                                           |
|                               | Set                    | Changes some property or properties in the block                 |                                                                                                  |                       |                                                                                           |
|                               |                        |                                                                  |                                                                                                  | /MAX:\<number>        | Sets the maximun displacement of the piston                                               |
|                               |                        |                                                                  |                                                                                                  | /MIN:\<number>        | Sets the minimun displacement of the piston                                               |
...
| Thrusters                     | Set                    | Changes some property or properties in the block                 | Al properties already changed                                                                    |                       |                                                                                           |
|                               |                        |                                                                  |                                                                                                  | /OVERRIDE:\<number>   | Sets the override value.<br>It must be between 0 and 1, where 0 is disabled and 1 is 100% |
| Warhead                       | Arm                    | Changes warhead status to armed                                  | Warhead is armed                                                                                 |                       |                                                                                           |
|                               | Disarm                 | Changes warhead status to disarmed                               | Warhead is disarmed                                                                              |                       |                                                                                           |
|                               | Detonate               | Detonates the warhead                                            | Inmediately                                                                                      |                       |                                                                                           |
|                               | Start                  | Begins timer countdown                                           | Timer coundown ends                                                                              |                       |                                                                                           |
|                               | Stop                   | Stops current timer countdown                                    | Timer countdown stops                                                                            |                       |                                                                                           |
