...
### Blocks
In the **instruction** region is is possible to set individual blocks or groups.
...
Some times it is necessary to write some text in the sequence to explain what is it doing. It is possible to write "human text" typing // before.
```
[COMMAND_NAME]
// Start automatically.
run
...
| LCDs & other display surfaces | Display                | Changes some property or properties in the block                | Are properties already changed                                                                   |                       |                                                                      |
